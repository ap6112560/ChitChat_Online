...
import com.chatt.demo.DeviceListFragment.DeviceActionListener;
import com.chatt.demo.model.Conversation_off;
...
public class DeviceDetailFragment extends ListFragment implements ConnectionInfoListener {
    ...
    private EmojiconEditText tview;
    ...
    public static ArrayList<Conversation_off> cList=new ArrayList<Conversation_off>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sw.setVisibility(View.VISIBLE);
        mContentView.findViewById(R.id.tv).setVisibility(View.VISIBLE);
        btn = (ImageView) mContentView.findViewById(R.id.emoji_btn);
        tview=(EmojiconEditText)mContentView.findViewById(R.id.txt);
        tview.setInputType(InputType.TYPE_CLASS_TEXT| InputType.TYPE_TEXT_FLAG_MULTI_LINE);
        View rootView = mContentView.findViewById(R.id.layout);
        emojIcon = new EmojIconActions(getActivity(), rootView, tview, btn);
    ...
    private class ChatAdapter extends BaseAdapter
    {
         ...
         */
        @Override
        public Conversation_off getItem(int arg0)
        {
        ...
        {
            Conversation_off c = getItem(pos);
            if (c.isSent())
            ...
            lbl = (EmojiconTextView) v.findViewById(R.id.lbl2);
                    ...
                    while (socket.isConnected()) {
                        try {
                            ...
                            if (num > 0) {
                                ...
                                cList.add(new Conversation_off(recvedMessage,new Date(),deviceName));
                        ...
                        try {
                            ...
                            if (msg != null && msg.length() > 0) {
                                synchronized (socket) {
                                    ...
                                    cList.add(new Conversation_off(msg,new Date(),DeviceListFragment.device.deviceName));
                                    msg=null;
                                    handle.post(new Runnable() {
                                        @Override
                                        public void run() {
